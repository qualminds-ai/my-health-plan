    ...
    return (
        <div className={styles.cmOverviewContainer}>
            ...
            <div className={styles.riskStratificationSection}>
                ...
                {/* Main Layout - Left Column (Conditions + Social Determinants) and Right Column (Programs + Care Gaps + Medications) */}
                <div className={styles.sideBySideContainer}>
                    {/* Left Column - Conditions and Social Determinants stacked */}
                    ...
                    {/* Right Column - Programs, Care Gaps, and Medications stacked */}
