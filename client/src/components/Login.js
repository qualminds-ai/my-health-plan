...
const Login = ({ onLogin }) => {
  ...
  return (
    <div id="login-page" className={styles.loginPage}>
      ...
      <div id="login-form-section" className={styles.loginFormSection}>
          ...
          <div className={styles.loginFormContent}>
            ...
            <div id="login-header" className={styles.loginHeader}>
              <div className={styles.loginLogoContainer}>
                <svg
                  id="login-logo-icon"
                  width="56" height="57" viewBox="0 0 56 57" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.loginLogoIcon}>
                ...
                <h1
                  ...
                  className={styles.loginBrandTitle}>
                  MyHealthPlan
                </h1>
              </div>
            </div>          {/* Login Form */}
            <form id="login-form" onSubmit={handleSubmit} className={styles.loginForm}>
              {/* Form Container - Centers all elements */}
              <div className={styles.formFieldsContainer}>
                {/* Email Field */}
                <div id="email-field-container" className={styles.fieldContainer}>
                  <svg
                    id="email-icon"
                ...
                {/* Password Field */}
                <div id="password-field-container" className={styles.fieldContainer} style={{ marginBottom: '40px' }}>
                  <svg
                    id="password-icon"
                    width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"
                    className={styles.fieldIcon}>
                ...
                {/* Links */}
                <div id="form-links" className={styles.formLinks}>
                  <button
        ...
        {/* Copyright at bottom */}
        <div id="copyright-section" className={styles.copyrightSection}>
          <p id="copyright-text" className={styles.copyrightText}>
      ...
      >
        ...
        <div id="background-overlay" className={styles.backgroundOverlay}></div>
      </div>
    </div>
  );
};
